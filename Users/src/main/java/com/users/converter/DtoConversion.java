...
public final class DtoConversion {
   ...
   */
  public static User convertUserRequestToUser(final UserInDto userRequest) {
    User user = new User();
   ...
   */
  public static UserOutDto convertUserToUserResponse(final User user) {
   ...
   */
  public static User convertUpdateUserRequestToUser(final User existingUser,
                                                    final UpdateUserInDto request) {
   ...
   */
  public static UpdateUserOutDto convertUserToUpdateUserResponse(final User user) {
   ...
   */
  public static Address convertAddressRequestToAddress(final AddressInDto request) {
   ...
   */
  public static AddressOutDto convertAddressToAddressResponse(final Address address) {
   ...
   */
  public static Address convertUpdateAddressRequestToAddress(final AddressInDto request,
